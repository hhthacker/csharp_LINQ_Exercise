...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        public void WhatIsTheBirthdayOfTheYoungestStudentInCohort3()
        {
            ...
            var maxValue = PracticeData[2].Students.Max(Student => Student.Birthday); //HINT: Cohort3 is PracticeData[2]
        ...
        public void WhatIsTheBirthdayOfTheOldestStudentInCohort3()
        {
            ...
            var minValue = PracticeData[2].Students.Min(Student => Student.Birthday); //HINT: Cohort3 is PracticeData[2]
