...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        public void GetAllStudentsInCohort1ByBirthday()
        {
            ...
            var expected = PracticeData[0].Students.OrderBy(student => student.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            //var expected = PracticeData/*FILL IN LINQ EXPRESSION*/.ToList(); //HINT: Cohort1 is PracticeData[0]
            var expected = PracticeData[0].Students.OrderByDescending(student => student.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            //var expected = PracticeData/*FILL IN LINQ EXPRESSION*/.ToList();
            var expected = PracticeData[2].JuniorInstructors.OrderBy(instructor => instructor.LastName).ToList();
